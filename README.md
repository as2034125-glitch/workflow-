...
- 廣告導購請指向 **12 入**（SKU `VG00C2`，NT$660，庫存 196）。1 入（SKU `VG00C1`）庫存為 0，連過去會是缺貨頁。
- **落地頁的商品描述要先修**。商品頁目前寫「下午茶的美容補給」與「完美取代高糖手搖飲」，兩句都是影片刻意避開的說法。Meta 會連帶審查落地頁，詳見 `docs/04-廣告用字檢查.md`。
